    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse">
        <ul class="navbar-nav ms-auto">
          <li class="nav-item"><a class="nav-link text-light" href="#">NOSOTROS</a></li>
          <li class="nav-item"><a class="nav-link text-light" href="#">CALENDARIO</a></li>
          <li class="nav-item"><a class="nav-link text-light" href="#">GALERÍA</a></li>
          <li class="nav-item"><a class="nav-link text-light" href="#">ÚNETE</a></li>
        </ul>
      </div>
    </div>
  </nav>
